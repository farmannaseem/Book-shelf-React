...
After you have installed the dependencies, you can run the application locally using the following command:
npm start
...
Learn More
You can learn more about Create React App and React.js in the Create React App documentation and React documentation.
